...
const MiniHomePage = ({setShowBack, showBack}: 
    {
    ...
    return (
        ...
        >
          <h2 className="name-fade-animation fixed lg:-rotate-90 lg:-right-16 lg:top-20 z-30 lg:mr-5 lg:mt-3 text-nowrap overflow-hidden">
            Monte Yoon
          </h2>
